...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
								...
								<li><a href="insert-blog.php"><i class="menu-icon icon-table"></i>Insert Blog </a></li>
								<li><a href="manage-blogs.php"><i class="menu-icon icon-table"></i>Manage Blog </a></li>
								<li><a href="manage-feedbacks.php"><i class="menu-icon icon-table"></i>Manage Feedbacks </a></li>
