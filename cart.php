...
<!-- Mirrored from demo.egenslab.com/html/scooby/preview/cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Jan 2024 09:23:45 GMT -->
<head>
<meta charset="UTF-8">
...
$sql = "SELECT id, productImage1, productName, productPrice, productPriceBeforeDiscount FROM products WHERE id='$id'";
                ...
                <tbody>
                    <tr>
                        <td data-label="Delete">
                            <div class="delete-icon"><button>X</button></div>
                        </td>
                        <td><img src="admin/gallery/' . $row['productImage1'] . '" alt="error 404"></td>
                        <td>' . $row['productName'] . '</td>
                        <td class="unit-price">' . $row['productPrice'] . '</td>
                        <td>' . $row['productPriceBeforeDiscount'] . '</td>
                        <td>
                            <div class="quantity">
                        ...
                        <td class="subtotal">' . $row['productPrice'] . '</td>
                    </tr>
                </tbody>
            </table>
        </div>';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateSubtotal() {
        ...
        const price = parseFloat(unitPrice.innerText);
...
<li><a href="shop.php" class="primary-btn2 btn-lg">Continue to shopping</a></li>
<li><a href="check-out.php" class="primary-btn3 btn-lg">Proceed to Checkout</a></li>
</ul>
</div>
</div>
</div>
