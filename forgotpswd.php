...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = mysqli_prepare($con, "SELECT id, firstname FROM signup WHERE email = ?");
...
<title>Scooby - Forgot Password</title>
...
<section class="signup-section" style="padding: 80px 0;">
<div class="container">
<div class="row justify-content-center">
<div class="col-lg-5 col-md-8">
<div class="form-wrap" style="background:#fff;padding:40px;border-radius:12px;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
<h3 style="font-weight:700;margin-bottom:8px;">Forgot Password?</h3>
<p style="color:#666;margin-bottom:24px;">Enter your registered email address and we'll send you a reset link.</p>
...
<input type="email" name="email" class="form-control" placeholder="Enter your email address" style="height:48px;border-radius:8px;" required>
</div>
<button type="submit" class="primary-btn1 w-100" style="height:48px;font-size:16px;font-weight:600;">Send Reset Link</button>
</form>
<div class="text-center mt-3">
<a href="login.php" style="color:#ff6b35;"><i class="bi bi-arrow-left"></i> Back to Login</a>
</div>
</div>
</div>
</div>
