...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = mysqli_prepare($con, "INSERT INTO billing (firstname, lastname, country_region, streetaddress, town_city, phone_no, email, postcode) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    mysqli_stmt_bind_param($stmt, "ssssssss", $firstname, $lastname, $country, $streetaddress, $town, $phone, $email, $postcode);
...
<!-- Mirrored from demo.egenslab.com/html/scooby/preview/check-out.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Jan 2024 09:23:45 GMT -->
<head>
<meta charset="UTF-8">
...
<li class="active"><a href="check-out.php">Check Out</a></li>
</ul>
</li>
<li class="menu-item-has-children">
...
<input type="text" name="country_region" placeholder="Your country name" required>
</div>
</div>
<div class="col-12">
<div class="form-inner">
<label>Street Address</label>
<input type="text" name="streetaddress" placeholder="House and street name" required>
</div>
</div>
<div class="col-12">
<div class="form-inner">
...
<input type="tel" name="phone_no" placeholder="Your Phone Number" pattern="[0-9]{10}" required>
</div>
</div>
<div class="col-12">
<div class="form-inner">
<input type="email" name="email" placeholder="Your Email Address" pattern="(^[^\s@]+@[^\s@]+\.[^\s@]+$)" required>
</div>
</div>
<div class="col-12">
<div class="form-inner">
...
<!-- Mirrored from demo.egenslab.com/html/scooby/preview/check-out.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Jan 2024 09:23:46 GMT -->
</html>